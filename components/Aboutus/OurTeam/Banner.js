...
const Banner = () => {
    return (
        <Container fluid className='m-0 p-0' style={{ backgroundImage: 'url("/aboutus/our-team/our_team_banner.jpeg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '400px' }}>
